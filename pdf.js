...
doc.image('C:/Users/Admin/Downloads/page4.png', { width: 550 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the second page
doc.image('C:/Users/Admin/Downloads/page5.png', { width: 500 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the third page
doc.image('C:/Users/Admin/Downloads/page6.png', { width: 550 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the fourth page
doc.image('C:/Users/Admin/Downloads/page7.png', { width: 550 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the fifth page
doc.image('C:/Users/Admin/Downloads/page8.png', { width: 550 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the sixth page
doc.image('C:/Users/Admin/Downloads/page9.png', { width: 550 });

// Add a new page to the PDF document
doc.addPage();

// Add image to the seventh page
doc.image('C:/Users/Admin/Downloads/page10.png', { width: 550 });


// Save the PDF file to disk
doc.pipe(fs.createWriteStream('C:/Users/Admin/Downloads/output.pdf'));
